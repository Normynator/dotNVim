...
install () {
	...
	echo "Final step. Copying files."
	echo "TODO: add instructions when first running neovim"
	cp -r * $INSTALL_PATH
	echo "Done. Now you can run nvim and start working :)"
}
...
generate () {
	...
	echo '" AUTOGENERATED - changes will be overwritten' > $MP
